...
class SobreView extends JDialog implements ActionListener{
	/**
	 * 
	 */
	...
	public SobreView(javax.swing.JFrame parent, boolean modal){
		super(parent, modal);
		initSobre();
		}
	
	public static void sobre(){
		JDialog Sobre = new SobreView(new javax.swing.JFrame(), true);
	...
	public void initSobre(){
		...
		/*Esta linha está funcionando localmente*/
...
//		}
		...
		/*
		 * Lê arquivo de configuracao do projeto 
		 */
		...
		icone = new ImageIcon(lerArquivoVO.getLogoTipo()+"logo_cs_b.gif");
		setIconImage(icone.getImage());
		//Imagem de dentro da tela
		//icone_c = new ImageIcon(sobre_img+"logo_cs_c.gif");
		icone_c = new ImageIcon(lerArquivoVO.getSobreImg()+separadorPath+"logo_cs_c.gif");
		...
		lblMsg2 = new JLabel("E um programa para controle");
		...
		lblMsg4 = new JLabel("prestadora de servicos de motoboy.");
...
//		lblMsg10 = new JLabel("CS Consultoria em Informatica");
		lblMsg10 = new JLabel("Clovis Silverio");		
		lblMsg11 = new JLabel("Versao : 1.0  -  2010");
